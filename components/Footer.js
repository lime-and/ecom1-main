...
export default function Footer() {
  ...
  return (
    <footer className="sticky bottom-0 bg-white p-5 w-full flex border-t border-gray-200 justify-center space-x-12 text-gray-400">
      <Link href={'/'}>
        <a className={(path === '/' ? 'text-yellow-400' : '')+" flex justify-center items-center flex-col"}>
      ...
      <Link href={'/checkout'}>
        <a className={(path === '/checkout' ? 'text-yellow-400' : '')+" flex justify-center items-center flex-col"}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
